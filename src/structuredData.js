...
const addDatePublished = markdownRemark =>
  assocPath(['frontmatter', 'structuredData', 'datePublished'], getDate(markdownRemark), markdownRemark);
...
const addHeadline = markdownRemark =>
  assocPath(['frontmatter', 'structuredData', 'headline'], getHeadline(markdownRemark), markdownRemark);

const getArticleBody = pipe(prop('html'));

const addArticleBody = markdownRemark =>
  assocPath(['frontmatter', 'structuredData', 'articleBody'], getArticleBody(markdownRemark), markdownRemark);
...
const addLanguage = markdownRemark => assocPath(['fields', 'langKey'], getLangKey(markdownRemark), markdownRemark);
...
const getStructuredDataForAuthor = pipe(
  renameType,
  addContext,
  cleanStructuredData,
  JSON.stringify

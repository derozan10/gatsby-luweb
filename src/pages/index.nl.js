            ...
            <section className="serviceCards">
              <Link to="/nl/diensten" state={{ service: "development" }}>
                <Card
                  ...
                  title='Website'
                  text={
                    <p>We maken super performante websites die doelgericht, gebruiksvriendelijk en geoptimaliseerd zijn voor alle mobiele apparaten.</p>
                  }
                />
              </Link>
              ...
              <Link to="/nl/diensten" state={{ service: "development" }}>
                <Card
                  ...
                  text={<p>We verhogen de zichtbaarheid van jouw onderneming en betrekken klanten door slim gebruik te maken van alle relevante kanalen.</p>}
                />
              </Link>
            </section>
          </Fade>
        ...
        <Container>
          ...
          <div className="flexSEO">
            <div>
              ...
              <p>
                Luweb heeft als webdesign bureau voldoende ervaring om een goed converterende website te maken die gezien mag worden.
                Daarnaast denken we mee na over het online imago alsook de strategie van je bedrijf. Zo haal je het meeste rendement uit je website.
          </p>
            </div>
            <div>
          ...
          <p>
            We zoeken steeds naar de beste oplossing binnen jouw budget. Nog niet meteen nood aan sociale media maar wil je gewoon starten met een website? Geen probleem, uiteraard kunnen we jouw pakket later nog uitbreiden.
          </p>
        </Container>

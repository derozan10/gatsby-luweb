                    ...
                    <div style={{ padding: '20px 0' }}>
                        ...
                        <StyledServices>
                            <div id="serviceSections">
                                <section className="serviceSection" id="design">
                                    <svg
                                        fill="none"
                                        height="60"
                                        viewBox="0 0 60 60"
                                ...
                                <section className="serviceSection" id="development">
                                    <svg
                                        fill="none"
                                        height="60"
                                        viewBox="0 0 60 60"
                                ...
                                <section className="serviceSection" id="performance">
                                    <svg
                                        fill="none"
                                        height="60"
                                        viewBox="0 0 60 60"
                                ...
                                <section id="analytics" className="serviceSection">
                                    <svg
                                        fill="none"
                                        height="60"
                                        viewBox="0 0 60 60"

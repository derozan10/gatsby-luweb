        ...
        <div id="serviceSections">
          ...
          <section className="serviceSection" id="seo">
            <div className="serviceDescription">
              ...
              <p>
                Websites die mobielvriendelijk, performant, zorgvuldig opgesteld, inhoudelijk sterk... zijn, worden
                hoger weergegeven in zoekmachines als Google. We houden dan ook rekening met al deze zaken voor jouw
                website. Daarnaast kunnen we nog extra advertenties inzetten om nog hoger te eindigen in zoekmachines.
              </p>
            </div>
          </section>
          <section className="serviceSection" id="analyse">
            <div className="serviceDescription">
              ...
              <p>
                Bij de lancering van je website zetten we tracking tools op, waarmee we inzichten verwerven over de
                bezoekers en hun gedrag. We analyseren zo wat werkt (en wat niet) en gebruiken deze kennis om alle
                online kanalen aan te passen en zo de conversie te verhogen.
              </p>
            </div>
          </section>
          <section className="serviceSection" id="analytics">
            <div className="serviceDescription">
              ...
              <p>
                Facebook, Instagram, LinkedIn... We bekijken welke kanalen voor jou het meeste relevant zijn en zetten
                hier maximaal op in. We optimaliseren de conversie door je doelgroep zo specifiek mogelijk te maken. Op
                deze manier optimaliseren we jouw marketing-budget.
              </p>
            </div>
          </section>
        </div>
